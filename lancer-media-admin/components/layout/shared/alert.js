...
function Alert({label, content, type}) {
  return (
    <div className={cn({
      "border-t-4 px-4 py-3 shadow-md" : true,
      "bg-teal-100 border-teal-500 rounded-b text-teal-900": type === "Success",
      "bg-red-100 border-red-500 rounded-b text-red-900": type !== "Success",
      })} role="alert">
  <div className="flex">
